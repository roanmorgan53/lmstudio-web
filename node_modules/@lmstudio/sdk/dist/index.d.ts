...
declare interface ArtifactManifestBase {
    owner: string;
    name: string;
    description: string;
    revision?: number;
 ...
 * @public
 */
declare type ContentBlockStyle = {
    type: "default";
} | {
    type: "customLabel";
    label: string;
...
export declare const kvValueTypesLibrary: KVFieldValueTypeLibrary<{
    ...
    mlxKvCacheQuantizationStartType: {
        value: {
            value: number;
            checked: boolean;
        };
...
declare type LLMLlamaCacheQuantizationType = (typeof llmLlamaCacheQuantizationTypes)[number];
 ...
 * @public
 */
declare const llmLlamaCacheQuantizationTypes: readonly ["f32", "f16", "q8_0", "q4_0", "q4_1", "iq4_nl", "q5_0", "q5_1"];
 ...
 * @public
 */
export declare type LLMStructuredPredictionType = "none" | "json";
